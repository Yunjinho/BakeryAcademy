...
document
	...
	.addEventListener("click", function() {
		var signupSuccessful = true; // 회원가입 성공 여부를 나타내는 변수를 추가합니다.
		...
		console.log("Password: ", memberPassword); // 추가된 로그
		console.log("Confirm Password: ", memberPasswordConfirm); // 추가된 로그
